...
{
	MenuButton* button = new MenuButton(this, app_->getTexture("PLAY"), 200, 80, { 400, 550 }, app_, SDLApplication::toMenuState);
	addEventHandler(button);
	addGameObject(button);

	button = new MenuButton(this, app_->getTexture("EXIT"), 200, 80, { 680, 550 }, app_, SDLApplication::closeApplication);
	addEventHandler(button);
	addGameObject(button);
